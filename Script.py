class script(object):
    START_TXT = """𝙷𝙴𝙻o {},
𝙽𝙰𝙼𝙴 is <a href=https://t.me/{}>{}</a> Iam A Simple Auto Filter ++ Manual Filter + Extra Features Bot. I Can Provide Movies In Telegram Groups.I Can Also Add Filters In Telegram Groups.  Just Add Me To Your Group And Enjoy"""
    HELP_TXT = """𝙷𝙴𝚈 {}
